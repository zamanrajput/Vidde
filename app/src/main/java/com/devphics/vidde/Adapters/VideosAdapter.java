...
public class VideosAdapter extends RecyclerView.Adapter<VideosAdapter.viewHolder> {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.card_view_design_downloads, viewGroup, false);
    ...
    public void onBindViewHolder(final viewHolder holder, int i) {
        ...
        holder.tvSize.setText(getFileSize(vIdeosData.getSize()));
        int l = vIdeosData.getTitle().length();
        holder.title.setText(vIdeosData.getTitle().substring(0,l>12?l/2:l));
        holder.tvDescription.setText(vIdeosData.getMimeType());
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        TextView title,durationTv, tvDescription, tvSize;
        Button moreBtn;
        ...
        public viewHolder(View itemView) {
            super(itemView);
            moreBtn = itemView.findViewById(R.id.moreBtnIV);
            image = itemView.findViewById(R.id.imageview);
            title = itemView.findViewById(R.id.tvItemTitle);
            tvSize = itemView.findViewById(R.id.sizeTv);
