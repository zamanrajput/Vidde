package com.devphics.vidde.facebookapi;
...
public abstract class FacebookExtractor extends AsyncTask<Void,Integer, com.devphics.vidde.facebookapi.FacebookFile> {
    ...
    protected abstract void onExtractionComplete(com.devphics.vidde.facebookapi.FacebookFile facebookFile);
    protected abstract void onExtractionFail(Exception Error);

    private com.devphics.vidde.facebookapi.FacebookFile parseHtml(String url)
    {
        try {
            ...
            else
            {
                ...
                com.devphics.vidde.facebookapi.FacebookFile facebookFile = new com.devphics.vidde.facebookapi.FacebookFile();
    ...
    @Override
    protected com.devphics.vidde.facebookapi.FacebookFile doInBackground(Void... voids) {
        com.devphics.vidde.facebookapi.FacebookFile Ff = parseHtml(url);
        return Ff;
    }

    @Override
    protected void onPostExecute(com.devphics.vidde.facebookapi.FacebookFile facebookFiles) {
