...
import com.devphics.vidde.databinding.FragmentBusinessWhatsappVideoBinding;
...
public class BusinessWhatsAppVideoFragment extends Fragment {
    ...
    FragmentBusinessWhatsappVideoBinding binding;
    private RecyclerView recyclerView;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentBusinessWhatsappVideoBinding.inflate(inflater,container,false);
        ...
        recyclerView = binding.recylerViewVideosBW;
